...
import limePoster from '../assets/limePoster.jpg';
...
const PosterLime:  React.FC = () =>{
    return (
        ...
        >
          <h1 className="text-center mb-8 leading-none">
            <span className="block text-9xl font-bold font-didot tracking-wide"></span>
            <span className="block text-sm font-sans tracking-widest -mt-1"></span>
          </h1>
          
          <div className="w-full mb-8 border-white border-0">
            <img
              src={limePoster}
              alt="L.A.C. Atelier"
